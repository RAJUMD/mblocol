          ...
          <div data-role="main" class="ui-content">
            <div class="ui-grid-solo">
              <div class="ui-block-a">
                 ...
                 <a href="forgtpwd.php" data-transition="pop" style="font-size:13px;">forgot password ?</a><br>
                 <center>
                  <p>Not registered yet please sign up</p>
                    <a href="signup.php" data-transition="pop" type="submit" data-role="button" id="custom-btn" value="submit" style="background: rgb(4, 114, 76);color: rgb(255, 218, 3);
